      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 600, color: '#6B7280', marginBottom: '8px' }}>
              Smart Questions Predictor
            </h2>
            <p style={{ fontSize: '14px', color: '#9CA3AF', marginBottom: '20px', lineHeight: 1.6 }}>
              AI-predicted questions based on your specific job description. Get personalized preparation for your interview.
            </p>
            <button
              type="button"
              disabled
