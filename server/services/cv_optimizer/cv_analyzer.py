"""
CV Analyzer - AI-powered data extraction
Version: 4.0

CRITICAL: This module extracts data ONLY. Scoring is done by the scoring engine.
"""
...
def extract_cv_data(cv_text: str, call_ai_model=None) -> Dict[str, Any]:
    """
    Extract structured data from CV using AI.
    
    Args:
        cv_text: Raw CV text
        call_ai_model: Function to call AI model (injected dependency)
...
def get_empty_cv_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "structure": {
            ...
            "word_count": 0,
            "page_count": 1,
            "has_adequate_whitespace": True,
            "has_clear_hierarchy": True,
            "contact_at_top": True,
            "experience_prominent": True,
            "logical_order": True,
            "education_positioned": True,
        ...
        "experience": {
            ...
            "has_clear_titles": True,
            "all_have_titles": True,
            "all_have_companies": True,
            "all_have_dates": True,
            "dates_formatted_well": True,
            "gaps_detected": [],
            "jobs": []
        },
        "grammar": {
        ...
        "vagueness": {
            "vague_phrases_count": 0,
            "buzzword_count": 0,
            "has_specific_achievements": True
        },
        "skills": {
            "tech_keywords_count": 0,
            "tech_keywords_found": [],
        ...
        "education": {
            ...
            "certifications_have_dates": True,
            "education_complete": False,
            "education_concise": True,
            "gpa_value": None
        },
        "repetition": {
            "has_overused_words": False,
            "has_duplicate_phrases": False,
            "has_redundant_bullets": False,
            "skills_duplicated": False,
            "achievements_restated": False
        },
        "red_flags": {
            "ai_content_detected": False,
            "unprofessional_email": False,
            "personal_info_overshare": False,
            "has_photo": False,
            "has_age_dob": False,
            "has_references_line": False,
